...
?>
    <title>Get My Song Reviewed Settings</title>
	<meta name='description' content='Where you make changes to your Profile.'>
...
<?php
	    if (isset($_GET['success']) && empty($_GET['success'])) {
    		...
    		<h2 class="col-xs-12">Settings.</h2> <p><b>Note: Information you post here is made viewable to others.</b></p>
